...
date: 2026-04-08
---
Who wants open models that can run on a laptop? Who wants infinite intelligence without paying a dollar? Well, I definitely want that, and you probably do, too.

But, sadly, the current state of open models is such that you can’t run a good-enough model on an average laptop/PC.
...
Until then, you can get a free Gemma 4 31B IT API key from aistudio.google.com. The free tier is generous enough that you can’t use all the free tokens -- unless you need the API for programming-related tasks.