...
Replace `assets/images/home/pink-oleander.webp` and `assets/images/home/pink-oleander-640.webp`, then update the image paths in `index.njk` if the filenames change.
